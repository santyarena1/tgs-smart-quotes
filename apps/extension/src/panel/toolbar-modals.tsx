...
export function SendQuoteModal({
  ...
  const [message, setMessage] = useState(
    quote.version?.sentMessage ??
      `Hola! Te comparto el presupuesto ${quote.visibleNumber} por un total de ${formatArs(quote.version?.totalSaleCents)}. Cualquier consulta quedo a disposición.`,
  );
