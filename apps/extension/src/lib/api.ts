...
export const updateChatbotConversation=(chatKey:string,body:{displayName?:string|null;modeOverride?:ChatbotMode|null;clearEscalation?:boolean;lastQuoteFamilyId?:string|null;lastQuoteVersion?:number|null})=>api<ChatbotConversation>(`/chatbot/conversations/${encodeURIComponent(chatKey)}`,{method:"PUT",body});
