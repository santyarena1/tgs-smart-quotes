...
Produccion: Railway (web, API y worker). En local, `docker compose -f docker-compose.prod.yml up -d --build`. Vercel despliega solo la web (`apps/web`); la API sigue en Railway.
